...
#if (PMU_MAX_TRANSITION_DLY <= 20000)		//jiangyulei
#undef PMU_MAX_TRANSITION_DLY
...
static struct mutex dhdsdio_htclk_lock;
...
dhdsdio_htclk(dhd_bus_t *bus, bool on, bool pendok)
{
	...
	mutex_unlock(&dhdsdio_htclk_lock);
	return ret;
}
